...
#Allow a listing of embedded videos as well as adding multiple videos
class EmbeddedVideoIndexPage(Page):
    ...
    def videos(self):
        # Get list of live news pages that are descendants of this page
        videos = EmbeddedVideoPage.objects.live().descendant_of(self).order_by('-id')
        return videos
...
class EmbeddedVideoPage(Page):
    ...
    category = models.ForeignKey('news.CategoryPage', null=True, blank=True,
